...
public abstract class AbstractRequestMappingRegister implements RequestMappingRegister {

    @Override
    public void register(Class<?> clazz, String baseUrl, Method method) {
        String methodUrl = getMethodUrl(method);
        String url = getMethodUrl(baseUrl, methodUrl);
        ...
        System.err.println("url = "+url + " : mapping" + mapping);
        this.registerMapping(url, mapping);
